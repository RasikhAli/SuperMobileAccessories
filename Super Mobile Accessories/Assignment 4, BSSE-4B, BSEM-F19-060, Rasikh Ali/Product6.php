...
<html>
	<head>
		...
		<title>Super Mobile Accessories | Product-6 </title>
		<link rel="stylesheet" type="text/css" href="main.css">
		<link rel="stylesheet" type="text/css" href="Product6.css">
	...
	<body>
		...
		<div class="divproducts">
			...
			<div class="divheading1">
				...
				<h1><?php if($row['Product_No'] == "Product6") { echo $row['Product_Name']; ?> Details:</h1>

			</div>


			<a href="product6.php" target="_blank">
				<div class="product6">

				</div>
			</a>

			<div class="product6details">
