...
<html>
	<head>
		...
		<title>Super Mobile Accessories | Product-1 </title>
	...
	<body>
		...
		<div class="divproducts">
			...
			<div class="divheading1">
				...
				<h1><?php if($row['Product_No'] == "Product1") { echo $row['Product_Name'];  ?> Details:</h1>

			</div>


			<a href="product1.php" target="_blank">
				<div class="product1">
			...
			<div class="productdetails">
				...
				<p>
					▣ <?php echo $row['Product_Price']; ?> + 90 rs with FREE HOME DELIVERY
				</p>
			</div>
