...
<html>
	<head>
		...
		<title>Super Mobile Accessories | Product-5 </title>
		<link rel="stylesheet" type="text/css" href="main.css">
		<link rel="stylesheet" type="text/css" href="Product5.css">
	...
	<body>
		...
		<div class="divproducts">
			...
			<div class="divheading1">
				...
				<h1><?php if($row['Product_No'] == "Product5") { echo $row['Product_Name']; ?> Details:</h1>

			</div>


			<a href="product5.php" target="_blank">
				<div class="product5">

				</div>
			</a>

			<div class="product5details">
