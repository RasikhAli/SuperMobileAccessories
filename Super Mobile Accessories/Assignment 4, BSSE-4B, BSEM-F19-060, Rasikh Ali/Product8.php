...
<html>
	<head>
		...
		<title>Super Mobile Accessories | Product-8 </title>
		<link rel="stylesheet" type="text/css" href="main.css">
		<link rel="stylesheet" type="text/css" href="Product8.css">
	...
	<body>
		...
		<div class="divproducts">
			...
			<div class="divheading1">
				...
				<h1><?php if($row['Product_No'] == "Product8") { echo $row['Product_Name']; ?> Details:</h1>

			</div>


			<a href="product8.php" target="_blank">
				<div class="product8">

				</div>
			</a>

			<div class="product8details">
