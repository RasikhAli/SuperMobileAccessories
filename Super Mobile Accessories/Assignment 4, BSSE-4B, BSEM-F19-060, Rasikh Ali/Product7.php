...
<html>
	<head>
		...
		<title>Super Mobile Accessories | Product-7 </title>
		<link rel="stylesheet" type="text/css" href="main.css">
		<link rel="stylesheet" type="text/css" href="Product7.css">
	...
	<body>
		...
		<div class="divproducts">
			...
			<div class="divheading1">
				...
				<h1><?php if($row['Product_No'] == "Product7") { echo $row['Product_Name']; ?> Details:</h1>

			</div>


			<a href="product7.php" target="_blank">
				<div class="product7">

				</div>
			</a>

			<div class="product7details">
