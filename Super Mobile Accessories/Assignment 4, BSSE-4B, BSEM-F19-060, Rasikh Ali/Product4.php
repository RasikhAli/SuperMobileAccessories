...
<html>
	<head>
		...
		<title>Super Mobile Accessories | Product-4 </title>
		<link rel="stylesheet" type="text/css" href="main.css">
		<link rel="stylesheet" type="text/css" href="Product4.css">
	...
	<body>
		...
		<div class="divproducts">
			...
			<div class="divheading1">
				...
				<h1><?php if($row['Product_No'] == "Product4") { echo $row['Product_Name']; ?> Details:</h1>

			</div>


			<a href="product4.php" target="_blank">
				<div class="product4">

				</div>
			</a>

			<div class="product4details">
