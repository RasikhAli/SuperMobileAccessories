...
<html>
	<head>
		...
		<title>Super Mobile Accessories | Product-3 </title>
		<link rel="stylesheet" type="text/css" href="main.css">
		<link rel="stylesheet" type="text/css" href="Product3.css">
	...
	<body>
		...
		<div class="divproducts">
			...
			<div class="divheading1">
				...
				<h1><?php if($row['Product_No'] == "Product3") { echo $row['Product_Name']; ?> Details:</h1>

			</div>


			<a href="product3.php" target="_blank">
				<div class="product3">

				</div>
			</a>

			<div class="product3details">
			...
			<div class="productdetails">
				...
				<p>
					▣ Only for iPhone, Honor & Samsung are available
				</p>
				<p>
					▣ <?php echo $row['Product_Price']; ?> + 50rs with FREE HOME DELIVERY
				</p>
			</div>
